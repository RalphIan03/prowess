...
<head>
    <x-headers headerTitle="Dashboard" />
</head>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row gy-4">
                            ...
                            <x-CardComponent class="mdi mdi-account-school-outline text-success"
                                cardTitle="Number of Scholar" cardData="5,000" />
                            <x-CardComponent class="mdi mdi-account-outline text-danger" cardTitle="Number of Alumni"
                                cardData="1,080" />
                            <x-CardComponent class="mdi mdi-school-outline text-warning" cardTitle="Number of HEI"
                                cardData="100" />
                            <x-CardComponent class="mdi mdi-office-building" cardTitle="Number of Industry"
                                cardData="50" />
                                ...
                                <div class="card h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="card-info mt-4 pt-1 mt-lg-1 mt-xl-4">
                                            ...
                                            <p class="text-muted mb-lg-2 mb-xl-3">Total Scholars</p>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="card-info mt-4 pt-3">
                                                    ...
                                                    <div class="badge bg-label-secondary rounded-pill mt-1">Last Sales
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="tab-pane fade show active" id="navs-orders-id"
                                                ...
                                                <div class="table-responsive text-nowrap">
                                                    <table class="table table-borderless">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-heading fw-semibold ps-0">Email
                                                                    Marketing Campaign</td>
                                                                <td class="pe-0"><span
                                                            ...
                                                            <tr>
                                                                <td class="text-heading fw-semibold ps-0">Google
                                                                    Workspace</td>
                                                                <td class="pe-0">
                                                                    <span
                                                            ...
                                                            <tr>
                                                                <td class="text-heading fw-semibold ps-0">Affiliation
                                                                    Program</td>
                                                                <td class="pe-0"><span
                                                                        class="badge rounded-pill bg-label-primary">Active</span>
                                                                </td>
                                            ...
                                            <div class="tab-pane fade" id="navs-sales-id" role="tabpanel">
                                                <div class="table-responsive text-nowrap">
                                                    <table class="table table-borderless">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="text-heading fw-semibold ps-0">Create
                                                                    Audiences in Ads Manager</td>
                                                                <td class="pe-0"><span
                                                                        class="badge rounded-pill bg-label-primary">Active</span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td class="text-heading fw-semibold ps-0">Video
                                                                    campaign</td>
                                                                <td class="pe-0">
                                                                    <span
                                                                        class="badge rounded-pill bg-label-warning">Completed</span>
                                                ...
                                                <div class="table-responsive text-nowrap">
                                                    <table class="table table-borderless">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="text-heading fw-semibold ps-0">IGTV
                                                                    advertising</td>
                                                                <td class="pe-0">
                                                                    <span
                                                                        class="badge rounded-pill bg-label-warning">Completed</span>
                                                            ...
                                                            <tr>
                                                                <td class="text-heading fw-semibold ps-0">Stories
                                                                    advertising</td>
                                                                <td class="pe-0"><span
                                                                        class="badge rounded-pill bg-label-primary">Active</span>
                                                                </td>
                                                ...
                                                <div class="table-responsive text-nowrap">
                                                    <table class="table table-borderless">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="text-heading fw-semibold ps-0">Device
                                                                    advertising</td>
                                                                <td class="pe-0">
                                                                    <span
                                                                        class="badge rounded-pill bg-label-warning">Completed</span>
                                                            ...
                                                            <tr>
                                                                <td class="text-heading fw-semibold ps-0">Campaigning
                                                                </td>
                                                                <td class="pe-0"><span
                                                                        class="badge rounded-pill bg-label-primary">Active</span>
                                                                </td>
                                        ...
                                        <ul class="timeline card-timeline mb-0">
                                            <li class="timeline-item timeline-item-transparent">
                                                ...
                                                <div class="timeline-event">
                                                    <div class="timeline-header mb-1">
                                                        <h6 class="mb-2 fw-semibold">Create youtube video for next
                                                            product 😎</h6>
                                                        <small class="text-muted">Tomorrow</small>
                                                    </div>
                                                    <p class="text-muted mb-2">Product introduction and details video
                                                    </p>
                                                    <div class="d-flex">
                                            ...
                                            <li class="timeline-item timeline-item-transparent border-0">
                                                ...
                                                <div class="timeline-event pb-1">
                                                    <div class="timeline-header mb-1">
                                                        <h6 class="mb-2 fw-semibold">Meeting with joseph morgan for
                                                            next project</h6>
                                                    ...
                                                    <div class="d-flex">
                                                        <a href="javascript:void(0)" class="me-3">
                                                            ...
                                                            <span
                                                                class="fw-semibold text-muted">presentation.pdf</span>
                                                        </a>
                                                    </div>
                                                </div>
                                            </li>
