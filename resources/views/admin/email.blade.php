                        ...
                        <div class="card-body emails-list-header p-3 py-2">
                          ...
                          <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex align-items-center mb-0 mb-md-2">
                              ...
                              <div class="dropdown btn btn-icon btn-text-secondary rounded-pill">
                                <i
                                  class="mdi mdi-dots-vertical mdi-20px cursor-pointer"
                                  id="emailsActions"
                          ...
                          <div class="d-flex justify-content-between align-items-center mb-2">
                            <div class="d-flex align-items-center">
                              ...
                              <div class="dropdown btn btn-text-secondary btn-icon rounded-pill me-1">
                                <i
                                  class="mdi mdi-folder-outline mdi-24px cursor-pointer"
                              ...
                              <div class="dropdown btn btn-text-secondary btn-icon rounded-pill">
                                <i
                                  class="mdi mdi-label-outline mdi-24px cursor-pointer"
                                  id="dropdownLabelOne"
                                  data-bs-toggle="dropdown"
                                  aria-haspopup="true"
                                  aria-expanded="false">
                      ...
                      <div class="card-body app-email-view-header p-3 py-2">
                        ...
                        <div class="d-flex justify-content-between align-items-center py-2">
                          ...
                          <div class="d-flex">
                            <div class="dropdown ms-3">
                              <i
                                class="mdi mdi-dots-vertical mdi-24px cursor-pointer"
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="d-flex align-items-center">
                            ...
                            <div class="btn btn-text-secondary btn-icon rounded-pill">
                              <i
                                class="mdi mdi-email-outline mdi-24px cursor-pointer"
                                data-bs-toggle="sidebar"
                                data-target="#app-email-view"></i>
                            </div>
                            <div class="dropdown btn btn-text-secondary btn-icon rounded-pill">
                              <i
                                class="mdi mdi-folder-outline cursor-pointer mdi-24px"
                            ...
                            <div class="dropdown btn btn-text-secondary btn-icon rounded-pill">
                              <i
                                class="mdi mdi-label-outline cursor-pointer mdi-24px"
                                id="dropdownLabelTwo"
                                data-bs-toggle="dropdown"
                                aria-haspopup="true"
                                aria-expanded="false">
                        ...
                        <div class="card email-card-last mx-sm-4 mx-3 mt-4">
                          <div
                            ...
                            <div class="d-flex align-items-center">
                              ...
                              <div class="dropdown me-3">
                                <i
                                  class="mdi mdi-dots-vertical cursor-pointer mdi-20px"
                                  id="dropdownEmailOne"
                                  data-bs-toggle="dropdown"
                                  aria-haspopup="true"
                                  aria-expanded="false"></i>
                          ...
                          <div class="email-compose-actions d-flex justify-content-between align-items-center mb-2">
                            <div class="d-flex align-items-center">
                              ...
                              <label for="attach-file"
                                ><i class="mdi mdi-attachment mdi-20px cursor-pointer ms-2"></i
                              ></label>
                            ...
                            <div class="d-flex align-items-center">
                              ...
                              <button type="reset" class="btn ps-3 pe-0" data-bs-dismiss="modal" aria-label="Close">
