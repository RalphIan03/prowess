    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <a href="{{ url('') }}" class="app-brand-link" style="text-decoration: none">
            <span class="app-brand-logo demo">
                <span style="color: var(--bs-primary)">
                    <svg width="50" height="50" viewBox="0 0 38 20" fill="none"
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="{{url('login')}}">Log in</a>
                </li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            ...
                            <a class="btn-solid-lg page-scroll" href="{{url("signup")}}">Sign Up</a>
                        ...
                        <div class="swiper-container image-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="image-container">
                                        <img class="img-responsive imgsliderlogo" src="images/davsur-logo.png"
                                            alt="alternative">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="image-container">
                                        <img class="img-responsive imgsliderlogo" src="images/dost-logo.png"
                                            alt="alternative">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="image-container">
                                        <img class="img-responsive imgsliderlogo" src="images/um-logo.png"
                                            alt="alternative">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="image-container">
                                        <img class="img-responsive imgsliderlogo" src="images/placeholder.png"
                                            alt="alternative">
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Contact Us</h2>
                    {{-- <ul class="list-unstyled li-space-lg">
                        <li class="address">Lorem ipsum dolor sit amet consectetur adipisicing elit.</li>
                        <li><i class="fas fa-map-marker-alt"></i>PROWESS CONTACT INFORMATION</li>
